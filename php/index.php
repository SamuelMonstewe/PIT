...
$DiretorioDeUpload = 'D:\wampserver\www\PIT\imagens\\';
...
if(move_uploaded_file($_FILES['foto']['tmp_name'], $FotoMotorista) && move_uploaded_file($_FILES['carteira']['tmp_name'], $CarteiraMotorista) && move_uploaded_file($_FILES['crlv']['tmp_name'], $Crlv))
{
    print_r($_FILES);
}
